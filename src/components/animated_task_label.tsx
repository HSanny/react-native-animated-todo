...
import Animated, {
    ...
    withSequence, withDelay, interpolateColor
...
const AnimatedTaskLabel = memo((props: Props) => {
    ...
    const hstackAniamtedStyles = useAnimatedStyle(
        () => ({
    ...
    return (
        <Pressable onPress={onPress}>
            <AnimatedHStack alignItems="center" style={hstackAniamtedStyles}>
                {/* 当选取为 Done 状态时文字将会渐变浅色 */}
                <AnimatedText
                    fontSize={19}
                    noOfLines={1}
                    isTruncated px={1}
